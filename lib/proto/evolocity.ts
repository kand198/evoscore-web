...
export const Request = {
  ...
  fromJSON(object: any): Request {
    return {
      ...
      reset: isSet(object.reset) ? ResetRequest.fromJSON(object.reset) : undefined,
      config: isSet(object.config) ? ConfigRequest.fromJSON(object.config) : undefined,
      energy: isSet(object.energy) ? EnergyRequest.fromJSON(object.energy) : undefined,
      time: isSet(object.time) ? TimeRequest.fromJSON(object.time) : undefined,
      status: isSet(object.status) ? StatusRequest.fromJSON(object.status) : undefined,
    };
  },
  ...
  toJSON(message: Request): unknown {
    ...
    message.reset !== undefined && (obj.reset = message.reset ? ResetRequest.toJSON(message.reset) : undefined);
    message.config !== undefined && (obj.config = message.config ? ConfigRequest.toJSON(message.config) : undefined);
    message.energy !== undefined && (obj.energy = message.energy ? EnergyRequest.toJSON(message.energy) : undefined);
    message.time !== undefined && (obj.time = message.time ? TimeRequest.toJSON(message.time) : undefined);
    message.status !== undefined && (obj.status = message.status ? StatusRequest.toJSON(message.status) : undefined);
    return obj;
  },
  ...
  fromPartial<I extends Exact<DeepPartial<Request>, I>>(object: I): Request {
    ...
    message.reset = object.reset !== undefined && object.reset !== null ? ResetRequest.fromPartial(object.reset) : undefined;
    message.config = object.config !== undefined && object.config !== null ? ConfigRequest.fromPartial(object.config) : undefined;
    message.energy = object.energy !== undefined && object.energy !== null ? EnergyRequest.fromPartial(object.energy) : undefined;
    message.time = object.time !== undefined && object.time !== null ? TimeRequest.fromPartial(object.time) : undefined;
    message.status = object.status !== undefined && object.status !== null ? StatusRequest.fromPartial(object.status) : undefined;
    return message;
  },
};
...
export const ResetRequest = {
  encode(_: ResetRequest, writer: _m0.Writer = _m0.Writer.create()): _m0.Writer {
    return writer;
  },
...
export const ConfigRequest = {
  ...
  fromJSON(object: any): ConfigRequest {
    return {
      content: isSet(object.content) ? ConfigContent.fromJSON(object.content) : undefined,
    };
  },

  toJSON(message: ConfigRequest): unknown {
    const obj: any = {};
    message.content !== undefined && (obj.content = message.content ? ConfigContent.toJSON(message.content) : undefined);
    return obj;
  },

  fromPartial<I extends Exact<DeepPartial<ConfigRequest>, I>>(object: I): ConfigRequest {
    const message = createBaseConfigRequest();
    message.content = object.content !== undefined && object.content !== null ? ConfigContent.fromPartial(object.content) : undefined;
    return message;
  },
};
...
export const TimestampPair = {
  encode(message: TimestampPair, writer: _m0.Writer = _m0.Writer.create()): _m0.Writer {
  ...
  fromPartial<I extends Exact<DeepPartial<TimestampPair>, I>>(object: I): TimestampPair {
    const message = createBaseTimestampPair();
...
export const EnergyRequest = {
  encode(message: EnergyRequest, writer: _m0.Writer = _m0.Writer.create()): _m0.Writer {
    if (message.timestampPair !== undefined) {
      TimestampPair.encode(message.timestampPair, writer.uint32(10).fork()).ldelim();
    }
    return writer;
  },
  ...
  fromJSON(object: any): EnergyRequest {
    return {
      timestampPair: isSet(object.timestampPair) ? TimestampPair.fromJSON(object.timestampPair) : undefined,
    };
  },

  toJSON(message: EnergyRequest): unknown {
    const obj: any = {};
    message.timestampPair !== undefined && (obj.timestampPair = message.timestampPair ? TimestampPair.toJSON(message.timestampPair) : undefined);
    return obj;
  },

  fromPartial<I extends Exact<DeepPartial<EnergyRequest>, I>>(object: I): EnergyRequest {
    const message = createBaseEnergyRequest();
    message.timestampPair = object.timestampPair !== undefined && object.timestampPair !== null ? TimestampPair.fromPartial(object.timestampPair) : undefined;
    return message;
  },
};
...
export const TimeRequest = {
  encode(message: TimeRequest, writer: _m0.Writer = _m0.Writer.create()): _m0.Writer {
    if (message.time !== undefined) {
...
export const Response = {
  ...
  fromJSON(object: any): Response {
    return {
      ...
      config: isSet(object.config) ? ConfigResponse.fromJSON(object.config) : undefined,
      energy: isSet(object.energy) ? EnergyResponse.fromJSON(object.energy) : undefined,
      time: isSet(object.time) ? TimeResponse.fromJSON(object.time) : undefined,
      status: isSet(object.status) ? StatusResponse.fromJSON(object.status) : undefined,
    };
  },
  ...
  toJSON(message: Response): unknown {
    ...
    message.timestamp !== undefined && (obj.timestamp = Math.round(message.timestamp));
    message.uid !== undefined && (obj.uid = Math.round(message.uid));
    message.ack !== undefined && (obj.ack = message.ack ? Ack.toJSON(message.ack) : undefined);
    message.config !== undefined && (obj.config = message.config ? ConfigResponse.toJSON(message.config) : undefined);
    message.energy !== undefined && (obj.energy = message.energy ? EnergyResponse.toJSON(message.energy) : undefined);
    message.time !== undefined && (obj.time = message.time ? TimeResponse.toJSON(message.time) : undefined);
    message.status !== undefined && (obj.status = message.status ? StatusResponse.toJSON(message.status) : undefined);
    return obj;
  },
  ...
  fromPartial<I extends Exact<DeepPartial<Response>, I>>(object: I): Response {
    ...
    message.config = object.config !== undefined && object.config !== null ? ConfigResponse.fromPartial(object.config) : undefined;
    message.energy = object.energy !== undefined && object.energy !== null ? EnergyResponse.fromPartial(object.energy) : undefined;
    message.time = object.time !== undefined && object.time !== null ? TimeResponse.fromPartial(object.time) : undefined;
    message.status = object.status !== undefined && object.status !== null ? StatusResponse.fromPartial(object.status) : undefined;
    return message;
  },
};
...
export const EnergyFrame = {
  encode(message: EnergyFrame, writer: _m0.Writer = _m0.Writer.create()): _m0.Writer {
    if (message.endTimestamp !== 0) {
  ...
  fromJSON(object: any): EnergyFrame {
    return {
      endTimestamp: isSet(object.endTimestamp) ? Number(object.endTimestamp) : 0,
      averageVoltage: isSet(object.averageVoltage) ? Number(object.averageVoltage) : 0,
      averageCurrent: isSet(object.averageCurrent) ? Number(object.averageCurrent) : 0,
  ...
  toJSON(message: EnergyFrame): unknown {
    const obj: any = {};
    message.endTimestamp !== undefined && (obj.endTimestamp = Math.round(message.endTimestamp));
    message.averageVoltage !== undefined && (obj.averageVoltage = Math.round(message.averageVoltage));
    message.averageCurrent !== undefined && (obj.averageCurrent = Math.round(message.averageCurrent));
    message.totalEnergy !== undefined && (obj.totalEnergy = Math.round(message.totalEnergy));
    return obj;
  },

  fromPartial<I extends Exact<DeepPartial<EnergyFrame>, I>>(object: I): EnergyFrame {
    const message = createBaseEnergyFrame();
    message.endTimestamp = object.endTimestamp ?? 0;
...
export const EnergyResponse = {
  encode(message: EnergyResponse, writer: _m0.Writer = _m0.Writer.create()): _m0.Writer {
  ...
  fromJSON(object: any): EnergyResponse {
    return {
      frames: Array.isArray(object?.frames) ? object.frames.map((e: any) => EnergyFrame.fromJSON(e)) : [],
    };
  },
  ...
  toJSON(message: EnergyResponse): unknown {
    const obj: any = {};
    if (message.frames) {
      obj.frames = message.frames.map((e) => (e ? EnergyFrame.toJSON(e) : undefined));
    } else {
      obj.frames = [];
    }
    return obj;
  ...
  fromPartial<I extends Exact<DeepPartial<EnergyResponse>, I>>(object: I): EnergyResponse {
    const message = createBaseEnergyResponse();
    message.frames = object.frames?.map((e) => EnergyFrame.fromPartial(e)) || [];
    return message;
  },
};
...
export const TimeResponse = {
  encode(_: TimeResponse, writer: _m0.Writer = _m0.Writer.create()): _m0.Writer {
    return writer;
  },
  ...
  fromPartial<I extends Exact<DeepPartial<TimeResponse>, I>>(_: I): TimeResponse {
    const message = createBaseTimeResponse();
    return message;
  },
};
...
export const StatusResponse = {
  ...
  toJSON(message: StatusResponse): unknown {
    ...
    message.flashUsage !== undefined && (obj.flashUsage = Math.round(message.flashUsage));
    message.temperature !== undefined && (obj.temperature = Math.round(message.temperature));
    message.voltage !== undefined && (obj.voltage = Math.round(message.voltage));
...
export const ConfigContent = {
  encode(message: ConfigContent, writer: _m0.Writer = _m0.Writer.create()): _m0.Writer {
  ...
  fromJSON(object: any): ConfigContent {
    return {
      ...
      vehicleClass: isSet(object.vehicleClass) ? vehicleClassFromJSON(object.vehicleClass) : undefined,
    };
  },
  ...
  toJSON(message: ConfigContent): unknown {
    ...
    message.vehicleClass !== undefined && (obj.vehicleClass = message.vehicleClass !== undefined ? vehicleClassToJSON(message.vehicleClass) : undefined);
    return obj;
  },

  fromPartial<I extends Exact<DeepPartial<ConfigContent>, I>>(object: I): ConfigContent {
    const message = createBaseConfigContent();
